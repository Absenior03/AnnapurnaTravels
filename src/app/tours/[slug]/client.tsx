...
import { initializeRazorpayPayment, formatRupees, createRazorpayOrder } from '@/utils/razorpay';
                ...
                <div className="border border-gray-300 rounded-md p-4 mb-4">
                  ...
                  <div className="flex items-center justify-center p-2 bg-gray-50 rounded-md">
                    <img 
                      ...
                      className="h-8 mr-2" 
                    />
                    <span className="text-gray-700 font-medium">Razorpay Secure Checkout</span>
                  </div>
                </div>
              </div>
