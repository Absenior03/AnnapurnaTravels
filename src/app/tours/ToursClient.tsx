...
export default function ToursClient() {
  ...
  useEffect(() => {
    ...
    result = result.filter(
      tour => tour.duration >= durationRange[0] && tour.duration <= durationRange[1]
    );
    ...
    <>
      ...
      >
        <div className="text-center px-4">
          ...
          >
            Discover our expertly crafted tour packages that offer unforgettable experiences in the heart of the Himalayas.
          </motion.p>
        </div>
      </ParallaxBackground>
