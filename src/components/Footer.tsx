    ...
    <footer className="bg-gray-900 text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-medium text-emerald-400 mb-5 tracking-wide">
              Annapurna Tours
            </h3>
            <p className="text-gray-300 mb-6 font-light leading-relaxed">
              Experience the beauty and majesty of the Himalayas with our
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  href="/"
                  className="text-gray-300 hover:text-emerald-400 transition-colors font-light"
                >
                  Home
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a
                  href="mailto:info@annapurnatours.com"
                  className="text-gray-300 hover:text-emerald-400 transition-colors font-light"
                >
        ...
        <div className="border-t border-gray-800 mt-16 pt-10 text-center text-gray-400">
          <p className="font-light tracking-wide">
            © {currentYear} Annapurna Tours and Travels. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
